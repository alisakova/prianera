var accordion=document.querySelectorAll(".accordion");if(window.innerWidth<600)for(var i=0;i<accordion.length;i++)accordion[i].addEventListener("click",function(){this.classList.toggle("active");var i=this.nextElementSibling;i.style.maxHeight?i.style.maxHeight=null:i.style.maxHeight=i.scrollHeight+"px"});
...
$(document).ready(function(){$(".reviews-slider").length&&$(".reviews-slider").slick({infinite:!0,speed:500,fade:!0})}),$("._open-success-call-modal").click(function(e){return e.preventDefault(),$("#success-modal").modal(),!1}),$("._open-calc-modal").click(function(e){return e.preventDefault(),$("#success-calc-modal").modal(),!1}),$("._open-master-modal").click(function(e){return e.preventDefault(),$("#success-master-modal").modal(),!1}),$("._open-order-call-modal").click(function(e){return e.preventDefault(),$("#call-modal").modal(),!1});var characteristicsBlocks=document.querySelectorAll(".panel"),showMoreBtns=document.querySelectorAll("._show-more-btn"),body=document.querySelector("body");600<window.innerWidth&&(showMoreBtns.forEach(function(t){t.addEventListener("click",function(e){e.stopPropagation();var c=t.nextElementSibling;characteristicsBlocks.forEach(function(e){e.classList.contains("active")&&e!==c&&e.classList.remove("active")}),c.classList.toggle("active")})}),body.addEventListener("click",function(e){e.stopPropagation(),characteristicsBlocks.forEach(function(e){e.classList.contains("active")&&e.classList.remove("active")})}));
var openMenu=document.querySelector("._open-menu"),closeMenu=document.querySelector("._close-menu"),menu=document.querySelector("._menu");menu&&(openMenu.addEventListener("click",function(e){e.stopPropagation(),menu.classList.add("active")}),closeMenu.addEventListener("click",function(e){e.stopPropagation(),menu.classList.remove("active")}));
var timeOut;function scrollToTop(){0!=document.body.scrollTop||0!=document.documentElement.scrollTop?(window.scrollBy(0,-50),timeOut=setTimeout("scrollToTop()",10)):clearTimeout(timeOut)}$(document).ready(function(){$("body").on("click","._scroll-btn",function(o){o.preventDefault();var t=$(this).attr("href"),e=$(t).offset().top;$("body,html").animate({scrollTop:e},1500)})});
